...
(function ($) {
    ...
    $navPanelToggle = $('<a href="#navPanel" id="navPanelToggle"><i class="fas fa-bars"></i>&nbsp;&nbsp;Menu</a>').appendTo($wrapper);
    $header.scrollex({
        bottom: '5vh',
        enter: function () {
    ...
    $navPanel = $('<div id="navPanel">' + '<nav>' + '</nav>' + '<a href="#navPanel" class="close"><i class="fas fa-times"></i></a>' + '</div>').appendTo($body).panel({
        delay: 500,
        hideOnClick: true,
        hideOnSwipe: true,
        resetScroll: true,
